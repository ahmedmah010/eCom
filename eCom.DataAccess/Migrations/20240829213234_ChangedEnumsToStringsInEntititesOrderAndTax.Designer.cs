...
namespace eCom.DataAccess.Migrations
{
    ...
    [Migration("20240829213234_ChangedEnumsToStringsInEntititesOrderAndTax")]
    partial class ChangedEnumsToStringsInEntititesOrderAndTax
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryCoupon", b =>
                {
                    ...
                    b.HasKey("ApplicableCategoriesId", "CouponsId");
            ...
            modelBuilder.Entity("eCom.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCom.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCom.Models.Tax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCom.Models.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCom.Models.UserCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryCoupon", b =>
                {
                    b.HasOne("eCom.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("ApplicableCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eCom.Models.Coupon", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eCom.Models.UserAddress", b =>
                {
                    b.HasOne("eCom.Models.City", "City")
